...
<template>
  <div
    class="subscription-form z-20 mx-auto -mb-10 flex max-w-screen-sm flex-col bg-white px-4 py-8 drop-shadow-xl xl:mb-40 xl:bg-transparent xl:p-4 xl:py-0 xl:drop-shadow-none"
  >
    <UiMainTitle
